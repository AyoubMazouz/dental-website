...
const Slider = ({ id, alt, before, after }) => {
	...
	return (
		<div className="group w-full h-full relative rounded-xl shadow-lg border-gray border-2 overflow-hidden">
			<h5 className="z-10 absolute bottom-[10%] left-[80%] translate-x-[-50%] bg-light rounded-full py-1 px-2 opacity-75 text-primary">
				before
			</h5>
			<h5 className="z-10 absolute bottom-[10%] left-[20%] translate-x-[-50%] bg-light rounded-full py-1 px-2 opacity-75 text-primary">
				after
			</h5>
			<img
				src={before}
			...
			<div
				id={sliderId}
				className="h-full w-1 bg-light absolute top-0 pointer-events-none opacity-75">
