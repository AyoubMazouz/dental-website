  ...
  return (
        ...
        <div className="h-full py-[1.5rem]">
            ...
            <div className='flex flex-wrap gap-2 mx-8 mt-6'>
                {phone.map((v, id) => <p key={id} className="py-2 px-4 flex gap-2 items-center text-light text-base bg-secondary rounded-full"><MdPhone />{v}</p>)}
            </div>

            {/* Work Hours */}
            <h1 className='text-xl font-bold text-light mx-8 mt-6 mb-2'>Work Hours</h1>
